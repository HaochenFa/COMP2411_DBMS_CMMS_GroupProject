...
def sample_profile():
    ...
    return {"personal_id": "P001", "job_role": "Base-level Worker", "status": "Current"}
...
def sample_participation():
    ...
    return {"personal_id": "P001", "activity_id": "A001"}


@pytest.fixture
def sample_affiliation():
    """Sample affiliation data for testing."""
    return {"personal_id": "P001", "department": "COMP"}


@pytest.fixture
def sample_external_company():
    """Sample external company data for testing."""
    return {"name": "CleanCo Ltd", "contact_info": "contact@cleanco.com"}
