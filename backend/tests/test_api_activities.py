...
class TestActivitiesEndpoint:
    ...
    def test_get_activities_success(self, client, mock_get_db_connection):
        ...
        mock_cursor.fetchall.return_value = [
            {'activity_id': 'A001', 'type': 'Seminar', 'time': '2024-03-15 14:00:00',
             'organiser_name': 'John Doe', 'building': 'Block A', 'room': '101', 'floor': '1'}
        ]
    ...
    def test_create_activity_success(self, client, mock_get_db_connection, sample_activity):
