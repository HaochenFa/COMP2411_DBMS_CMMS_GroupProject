...
import BuildingSupervision from "./components/BuildingSupervision";
import { RoleProvider, useRole } from "./context/RoleContext";
import "./App.css";

// Main app content with routes
function AppContent() {
  const { isLoggedIn, hasPermission, isLoading } = useRole();
  ...
  return (
    <Layout>
      <Routes>
        {/* Dashboard - redirect to safety-search if no permission */}
        <Route
          path="/"
          element={
            hasPermission("canViewDashboard") ? (
              ...
              <Navigate to="/safety-search" replace />
            )
          }
        />
        ...
        />
        <Route
          path="/building-supervision"
          element={
            hasPermission("canViewBuildingSupervision") ? (
              <BuildingSupervision />
            ) : (
              <Navigate to="/" replace />
            )
